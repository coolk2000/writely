...
?>
	...
	<body>
      ...
      <div class="container">
		...
		<div class="container">
			<div>
				<h3 style="display:inline"><span class="glyphicon glyphicon-align-left" aria-hidden="true"></span> <?php echo $title; ?></h3><h4 style="display:inline;float:right;margin-left:-100px"><span class="label label-info">View</span><?php if ($private == 1) {echo "&nbsp<span class=\"label label-warning\" title=\"Only you can view this page\">Private <span class=\"glyphicon glyphicon-question-sign\" aria-hidden=\"true\"></span>";} ?></h4>
			</div>
